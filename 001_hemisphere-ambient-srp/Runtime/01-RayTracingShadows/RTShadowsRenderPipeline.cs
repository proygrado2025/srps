...
namespace UnityEngine.Rendering.RTShadowsRenderPipeline {
    public sealed class RTShadowsRenderPipeline : RenderPipeline {
        ...
        public RTShadowsRenderPipeline(RTShadowsRenderPipelineAsset asset) {
            // SimpleRTLightingMat = CoreUtils.CreateEngineMaterial(Shader.Find("Hidden/SimpleRTLighting"));

            RTShadowsShaderBindings._debugFloat = asset.debugFloat;
            RTShadowsShaderBindings._debugFloat2 = asset.debugFloat2;
            RTShadowsShaderBindings._debugFloat3 = asset.debugFloat3;
        ...
        protected override void Render(ScriptableRenderContext context, Camera[] cameras) {
            ...
            RTShadowsShaderBindings.SetPerFrameShaderVariables(context);

            foreach(Camera camera in cameras) {

                context.SetupCameraProperties(camera);
                RTShadowsShaderBindings.SetPerCameraShaderVariables(context, camera);
        ...
        void RenderRT(ScriptableRenderContext context, Camera camera) {
            ...
            RTShader.SetVector(Shader.PropertyToID("_debugFloat3"), RTShadowsShaderBindings._debugFloat3);
            RTShader.SetFloat(Shader.PropertyToID("_debugFloat"), RTShadowsShaderBindings._debugFloat);
            // Input
